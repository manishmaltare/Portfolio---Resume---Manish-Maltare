...
@media (max-width: 768px) {
    ...
    .circle-icon {
        width: 100px; height: 100px; font-size: 13px;
    }
}
</style>
...
def render_circle_links_fixed(project_name):
    links_map = {
        ...
        "Machine Learning Insights into GDP Drivers": {
            "Report": "https://drive.google.com/file/d/1Z0z1QTypvr6lqDpTgLb05LM_R5775P1T/view",
...
if menu == "About Me":
    ...
    # ---------------------- LINKEDIN BUTTON BELOW ABOUT ME ----------------------
    st.markdown("""
