...
if menu == "About Me":
    ...
    # NEW: Circular LinkedIn Icon/Link
    linkedin_html = """
    <div class="circle-container" style="margin-top: 25px; margin-bottom: 20px;">
        <a href="https://www.linkedin.com/in/manishmaltare" target="_blank">
            <div class="circle-icon" style="width: 100px; height: 100px; font-size: 15px;">
                LinkedIn
            </div>
        </a>
    </div>
