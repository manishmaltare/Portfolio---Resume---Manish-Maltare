...
    /* Adjust Main content container padding for MOBILE */
    .block-container {
...
    /* Smaller circular buttons for less screen clutter */
    .circle-container {
        gap: 15px;
    }
...
    # st.columns handles stacking on mobile by default, which is perfect.
